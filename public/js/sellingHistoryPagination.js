...
document.addEventListener("DOMContentLoaded",function(event){
    one.setAttribute("href","/sellingHistory?id="+one.innerText);   
    two.setAttribute("href","/sellingHistory?id="+two.innerText);
    three.setAttribute("href","/sellingHistory?id="+three.innerText);
