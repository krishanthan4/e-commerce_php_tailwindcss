                    ...
                    <div id="AllMainDiv">
                        <div id="CardsMaindiv" class="grid grid-cols-2 justify-center items-center">
                            ...
                            for ($x = 0; $x < $product_numRows; $x++) {
                                ...
                                ?>
                                <!-- card start -->
                                <div id="existCard" class="flex m-5 flex-col items-center bg-white border border-gray-200 rounded-lg shadow lg:flex-row lg:max-w-xl md:max-w-72  sm:max-w-60 hover:bg-gray-100 ">
